...
export class OrdineService {
  ...
  private apiServer = 'http://localhost:8080/api';
    ...
    getPizzeTotali(dateInput: Stats): Observable<number> {
      return this.http.post<number>(this.apiServer + "/ordine/pizzeTotaliBetween", dateInput, this.httpOptions );
    }

    getClientiVirtuosi(dateInput: Stats): Observable<Cliente[]> {
      return this.http.post<Cliente[]>(this.apiServer + "/ordine/clientiVirtuosiBetween", dateInput, this.httpOptions );
    }
}
